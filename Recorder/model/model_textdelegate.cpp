...
QStringList Template_TextDelegate::get_header()
{
    return _header;
}
int Template_TextDelegate::get_header_count()
{
    return _header.count();
}
void Template_TextDelegate::set_text(QList<QStandardItem *> list, QVariantMap info)
{
    QString text;
...
QStringList Device_TextDelegate::get_header()
{
    return _header;
}
int Device_TextDelegate::get_header_count()
{
    return _header.count();
}
void Device_TextDelegate::set_text(QList<QStandardItem *> list, QVariantMap info)
{
    QString text;
    ...
    for(int j = 0;j < _header.count();j++){
        ...
        if(_header.at(j) == "selected"){
            ...
            item->setData(info,Qt::UserRole);
            item->setFlags( (Qt::ItemFlag)(item->flags() | ~Qt::ItemIsUserCheckable | ~Qt::ItemIsUserTristate) );
...
QStringList Conference_TextDelegate::get_header()
{
    return _header;
}
int Conference_TextDelegate::get_header_count()
{
    return _header.count();
}
void Conference_TextDelegate::set_text(QList<QStandardItem *> list, QVariantMap info)
{
    QString text;
    ...
    for(int j = 0;j < _header.count();j++){
        ...
        if(_header.at(j) == "search"){
            ...
            text += info.value("user_name").toString();
...
Mark_TextDelegate::Mark_TextDelegate(QStringList header) :
    _header(header)
{

}

QStringList Mark_TextDelegate::get_header()
{
    return _header;
}
int Mark_TextDelegate::get_header_count()
{
    return _header.count();
}
void Mark_TextDelegate::set_text(QList<QStandardItem *> list, QVariantMap info)
{
    QString text;
