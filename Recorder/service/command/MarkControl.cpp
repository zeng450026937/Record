...
MarkControl::MarkControl(MarkDatabase *pDB, MessageBase *pMessager) :
    ...
    m_pMarkDB(pDB)
{
    AddActionProc(MB_CONFERENCE_MODE, MC_ADD_MARK_INFO, &MarkControl::AddMarkInfoReplay);
    AddActionProc(MB_CONFERENCE_MODE, MC_SET_MARK_INFO, &MarkControl::SetMarkInfoReplay);
    AddActionProc(MB_CONFERENCE_MODE, MC_DELETE_MARK_INFO, &MarkControl::DeleteConferenceMarkReplay);
    AddActionProc(MB_CONFERENCE_MODE, MC_GET_MARK_INFO, &MarkControl::GetConferenceMarkReplay);
    AddActionProc(MB_CONFERENCE_MODE, MC_GET_MARK_LIST, &MarkControl::GetAllConferenceMarkListReplay);
}

MarkControl::~MarkControl() {}

void MarkControl::AddMarkInfo(const QString &qstrConferenceUuid, const QString &qstrContent, int iTime)
{
    QJsonObject jsData;
...
void MarkControl::SetMarkInfo(const QString &qstrMarkUuid, const QString &qstrContent, int iTime)
{
    QJsonObject jsData;
...
void MarkControl::DeleteConferenceMark(const QString &qstrConferenceUuid, int iIndex)
{
    QJsonObject jsData;
    jsData.insert("conferenceUuid", qstrConferenceUuid);
...
void MarkControl::DeleteConferenceMarkReplay(bool bResult, const QJsonObject &jsData)
{
    if (bResult)
    {
        // ÓÐindexl
...
void MarkControl::GetConferenceMarkReplay(bool bResult, const QJsonObject &jsData)
{
...
{
    m_pMessage->sendMessage(MB_CONFERENCE_MODE, MC_GET_MARK_INFO, QJsonObject());
}

void MarkControl::GetAllConferenceMarkListReplay(bool bResult, const QJsonObject &jsData)
{
    // m_pMarkDB
}
