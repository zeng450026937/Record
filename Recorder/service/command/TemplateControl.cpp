...
TemplateControl::TemplateControl(RecorderShared *pRecorderShared, MessageBase *pMessager) :
    CommandBase(pMessager),m_pRecordShared(pRecorderShared)
{
    AddActionProc(MB_CONFERENCE_MODE, TC_ADD_TEMPLATE_INFO, &TemplateControl::AddTemplateInfoReply);
    AddActionProc(MB_CONFERENCE_MODE, TC_SET_TEMPLATE_INFO, &TemplateControl::SetTemplateinfoReply);
    AddActionProc(MB_CONFERENCE_MODE, TC_DELETE_TEMPLATE_INFO, &TemplateControl::DeleteTemplateInfoReply);
    AddActionProc(MB_CONFERENCE_MODE, TC_GET_TEMPLATE_INFO, &TemplateControl::GetTemplateInfoReply);
    AddActionProc(MB_CONFERENCE_MODE, TC_GET_TEMPLATE_LIST, &TemplateControl::GetTemplateListReply);
}
...
void TemplateControl::AddTemplateInfoReply(bool bResult, const QJsonObject &jsData)
{
    m_pRecordShared->receive_templateInfoAdded(bResult, jsData.toVariantMap());
}

void TemplateControl::SetTemplateinfo(const QString &qstrTemplateUuid, const QString &qstrTitle, const QString &qstrContent, const QString &qstrMembers)
{
    QJsonObject jsData;
...
void TemplateControl::SetTemplateinfoReply(bool bResult, const QJsonObject &jsData)
{
...
void TemplateControl::DeleteTemplateInfoReply(bool bResult, const QJsonObject &jsData)
{
...
void TemplateControl::GetTemplateInfoReply(bool bResult, const QJsonObject &jsData)
{
...
{
    m_pMessage->sendMessage(MB_CONFERENCE_MODE, TC_GET_TEMPLATE_LIST, QJsonObject());
}

void TemplateControl::GetTemplateListReply(bool bResult, const QJsonObject &jsData)
{
