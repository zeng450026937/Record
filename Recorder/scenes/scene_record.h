...
private slots:
    ...
    void receive_record_notify(QString device_mac, QString device_name, QString status);
...
private slots:
    ...
    void receive_download_notify(int type, QString uuid, int percentage, bool completed);
